...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { artist: @art.artist, dimensions: @art.dimensions, museum: @art.museum, technique: @art.technique, title: @art.title, year: @art.year } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { artist: @art.artist, dimensions: @art.dimensions, museum: @art.museum, technique: @art.technique, title: @art.title, year: @art.year } }
